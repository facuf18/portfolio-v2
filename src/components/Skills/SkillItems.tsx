    ...
    <div className='flex flex-wrap self-center justify-center w-full max-w-2xl gap-6 px-2 pt-2 sm:px-0'>
      <span className='flex flex-col items-center gap-1 transition-all duration-300 ease-in-out cursor-pointer hover:scale-125'>
        <svg
          ...
          className='fill-primary-100 dark:fill-primary-400'
        >
          <path
            d='M0 0h256v256H0V0z'
        ...
        <p className='font-light uppercase font-body text-primary-500 dark:text-primary-50'>
          Javascript
        </p>
      </span>
      <span className='flex flex-col items-center gap-1 transition-all duration-300 ease-in-out cursor-pointer hover:scale-125'>
      ...
      <span className='flex flex-col items-center gap-1 transition-all duration-300 ease-in-out cursor-pointer hover:scale-125'>
        ...
        >
          <path
            className='fill-primary-1000 dark:fill-primary-300'
