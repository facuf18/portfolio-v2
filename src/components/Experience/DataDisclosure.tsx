        ...
        {({ open }) => (
          <>
            <Disclosure.Button
              ...
              } w-full p-2 text-sm font-medium text-left transition duration-300 ease-in-out border-b rounded-t border-primary-400 dark:border-primary-100 focus:outline-none hover:cursor-pointer hover:bg-primary-200 dark:hover:bg-primary-300`}
            >
            ...
            >
              <Disclosure.Panel className='p-2 mb-1 rounded-b bg-primary-200 dark:bg-primary-300'>
